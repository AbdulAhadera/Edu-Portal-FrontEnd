            ...
            {incompleteAssignments.map((a) => (
              ...
              >
                <div className="flex justify-between items-center mb-1">
                  <p className="text-sm font-semibold text-text-main">{a.assignmentTitle}</p>
                  <span
                    className={`text-[10px] px-2 py-0.5 rounded-full font-semibold ${a.status === "Late" ? "bg-red-600 text-white" : "bg-yellow-600 text-white"
                      }`}
                  >
                    {a.status}
                  </span>
